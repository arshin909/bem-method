...
Методология БЭМ предоставляет правила огранизации веб-проектов, независимо от их размера или количества разработчиков в команде.

Используйте БЭМ в своем проекте, если хотите:

Повторно использовать верстку
Даже в пределах одностраничного проекта блоки в интерфейсе могут повторяться. Например, блоки социальных иконок в шапке и подвале, или кнопки.
...
Масштабировать код
Любой компонент страницы может потребоваться изменить
Меню в шапке и в подвале можно изменять


Поддержка проекта не зависит от конкретного разработчика:
быстрая разработка
Быстрое разворачивание проекта (Быстро можно начать с готового project-stub)
...
Даже в пределах одностраничного проекта блоки интерфейса могут повторяться. Например, блоки соц иконок в шапке и подвале, или кнопки.

быстрая разработка

Уровни переопределения - подключение библиотек и доработка под свои нужды, Бесплатное обновление
...
БЭМ не стои использовать, если вы самостоятельно разрабатываете один одностраничный сайт, который не нужно поддерживать, и после окончания разработки вы планируете сменить сферу деятельности :)
