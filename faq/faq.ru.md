...
БЭМ-методология предоставляет способ огранизации любых проектов, независимо от их размеров, или размеров команд, которые над ними работают.

БЭМ полезен в любом проекте, к которому предъявляются следующие требования:
